...
export class JobService {
    ...
    loadContainers(jobId) {
        return this.httpClient.get<AttempRequestInterface>(
            `${this.configService.BASE_URL}/${this.jobPrefix}/${jobId}/containers`
        ).pipe(map(data => {
            return data;
        }));
    }
